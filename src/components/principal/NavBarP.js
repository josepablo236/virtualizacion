...
const NavBarP = () => {
    ...
    const { isAuthenticated, guardarIsAdmin, setIsAuthenticated, guardarRegresar, guardarCargar, guardarFoto, guardarNombre, guardarErrorfoto, guardarEmocion, guardarReco } = useContext(ImagenContext);
